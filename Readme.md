...
2. This repository use publicly available GCP Docker images within the Kubernetes deployment manifests, source of the project can be found at [GCP Demo project (Boutique)](https://github.com/GoogleCloudPlatform/microservices-demo)
